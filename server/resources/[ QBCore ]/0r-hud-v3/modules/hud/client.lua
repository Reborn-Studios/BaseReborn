...
local function updateBars()
    ...
    --health
    local maxHealth = GlobalState['Basics']['MaxHealth'] or GetEntityMaxHealth(ped)
    local baseHealth = GetEntityHealth(ped)
    local playerHealthPercent = ((baseHealth - 100) / (GetPedMaxHealth(ped) - 100)) * 100
    local health = playerHealthPercent
