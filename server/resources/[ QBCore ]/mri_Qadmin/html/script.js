...
AdminPanel.Init = function () {
    ...
    window.addEventListener("message", function (event) {
      switch (event.data.action) {
        ...
        case "adminchat": {
          ...
          if (
            AdminPanel.IsOpen &&
            (AdminPanel.LoadingAdminChat || AdminPanel.AdminChatOpen)
          ) {
  ...
  $(document).on("click", "#joblistfireplayer", function (e) {
    ...
    bootbox.confirm({
      ...
      message:
        AdminPanel.Language.fireTranslation +
        " <strong>" +
        $(this).data("name") +
        "</strong> " +
        AdminPanel.Language.FireFromTheirJobTranslation,
      centerVertical: true,
      buttons: {
        confirm: {
  ...
  $(document).on("click", "#ganglistfireplayer", function (e) {
    ...
    bootbox.confirm({
      ...
      title: AdminPanel.Language.AreYouSureTranslation,
      message:
        "Remove <strong>" + $(this).data("name") + "</strong> from their gang?",
      centerVertical: true,
      buttons: {
        confirm: {
          label: "Remove Player",
  ...
  $(document).on("click", "#characterslistdelete", function (e) {
    ...
    bootbox.confirm({
      ...
      title: AdminPanel.Language.AreYouSureTranslation,
      message:
        AdminPanel.Language.deleteTranslation +
        " " +
        $(this).data("name") +
        "?",
      centerVertical: true,
  ...
  $(document).on("click", "#joblistsetrank", function (e) {
    ...
    bootbox.prompt({
      title:
        AdminPanel.Language.setJobGradeTranslation + ` ${$(this).data("name")}`,
      message:
        AdminPanel.Language.JobGradeAssignedTranslation +
        ` ${$(this).data("name")}`,
      centerVertical: true,
      buttons: {
        confirm: {
  ...
  $(document).on("click", "#ganglistsetrank", function (e) {
    ...
    bootbox.prompt({
      title:
        AdminPanel.Language.setGangGradeTranslation +
        ` ${$(this).data("name")}`,
      message:
        AdminPanel.Language.GangGradeAssignedTranslation +
        ` ${$(this).data("name")}`,
      centerVertical: true,
      buttons: {
        confirm: {
  ...
  $(document).on("click", "#reportlistdeletereport", function (e) {
    ...
    bootbox.confirm({
      title:
        AdminPanel.Language.deleteReportTranslation + ` ${$(this).data("id")}?`,
      message:
        AdminPanel.Language.confirmDeleteReportTranslation +
        ` ${$(this).data("id")}?`,
      centerVertical: true,
      buttons: {
        confirm: {
  ...
  $(document).on("click", "#reportlistclaimreport", function (e) {
    ...
    bootbox.confirm({
      title:
        AdminPanel.Language.claimReportIdTranslation +
        ` ${$(this).data("id")}?`,
      message:
        AdminPanel.Language.confirmClaimReport + ` ${$(this).data("id")}?`,
      centerVertical: true,
      buttons: {
        confirm: {
  ...
  $(document).on("click", ".player", function (e) {
    ...
    AdminPanel.EditingPlayerInfo =
      AdminPanel.PlayerList[parseInt(editingplayerindex)];
    $("#onlineactions").show();
    ...
    if (AdminPanel.IsOpen) {
      ...
      if (AdminPanel.ReportsList[reportId] != null) {
        ...
        $("#reportinfobox").append(
          `
                    <strong>` +
            AdminPanel.Language.ReportTranslation +
            `</strong> ${AdminPanel.ReportsList[reportId].SenderName}<br/>
                    <strong>` +
            AdminPanel.Language.ReportTypeTranslation +
            `</strong> ${AdminPanel.ReportsList[reportId].Type}<br/>
                    <strong>` +
            AdminPanel.Language.ReportSubjectTranslation +
            `</strong> ${AdminPanel.ReportsList[reportId].Subject}<br/>
                    <strong>` +
        ...
        $("#reportsFooter").append(
          `
                    <button type="button" class="btn btn-secondary reportReply" id="` +
            AdminPanel.ReportsList[reportId].SenderName +
            `" data-dismiss="modal"><span id="ReportReplyTranslation">` +
            AdminPanel.Language.ReportReplyTranslation +
            `</span></button>
  ...
  $(document).on("click", ".reportReply", function (e) {
    ...
    bootbox.prompt({
      ...
      message:
        AdminPanel.Language.replyToConfirmTranslation +
        ` ${$(this).attr("id")}`,
      centerVertical: true,
      buttons: {
        confirm: {
  ...
  $(document).on("click", ".confirm-yes", function (e) {
    if (AdminPanel.ConfirmingAction.action == "ban") {
      ...
      if (
        $("#itemname").val().length < 1 ||
        $("#itemamount").val().length < 1
      ) {
        AdminPanel.ShowAlert(
          "danger",
          "<strong>ERROR:</strong>" +
      ...
      AdminPanel.ConfirmingAction.primarycolor =
        $("#rgb1").minicolors("rgbObject");
      AdminPanel.ConfirmingAction.secondarycolor =
        $("#rgb2").minicolors("rgbObject");
    }
    $.post(
  ...
  $(document).on("click", ".action", function (e) {
    ...
    if (action == "clearinv") {
      bootbox.confirm({
        title: AdminPanel.Language.AreYouSureTranslation,
        message:
          AdminPanel.Language.ClearInventoryOfPlayerTranslation +
          "<strong>" +
          AdminPanel.EditingPlayerInfo.name +
          "</strong>",
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      bootbox.prompt({
        title: AdminPanel.Language.AreYouSureTranslation,
        message:
          `<strong>KICK</strong> ${AdminPanel.EditingPlayerInfo.name}? ` +
          AdminPanel.Language.reasonTranslation,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      AdminPanel.ConfirmingAction.citizenid =
        AdminPanel.EditingPlayerInfo.citizenid;
      bootbox.prompt({
        title: AdminPanel.Language.AreYouSureTranslation,
        message:
          `<strong>` +
          AdminPanel.Language.warnTranslation +
          `</strong> ${AdminPanel.EditingPlayerInfo.name}? ` +
          AdminPanel.Language.reasonTranslation,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      $("#confirm-body").html(
        `
                ...
                <select class="custom-select" name="timeamt" id="timeamt">
                    <option value="1">1 ` +
          AdminPanel.Language.hourTranslation +
          `</option>
                    <option value="2">2 ` +
          AdminPanel.Language.hourTranslation +
          `</option>
          ...
          `</option>
                    <option value="24">1 ` +
          AdminPanel.Language.dayTranslation +
          `</option>
                    <option value="48">2 ` +
          AdminPanel.Language.dayTranslation +
          `</option>
          ...
          `</option>
                    <option value="168">1 ` +
          AdminPanel.Language.weekTranslation +
          `</option>
                    <option value="9999" style="color:red">` +
          AdminPanel.Language.permanentTranslation +
          `</option>
                </select><br/>
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.giveCashTranslation +
          `</strong> to ${AdminPanel.EditingPlayerInfo.name}?<br/><br/>` +
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.removeCashTranslation +
          `</strong> from ${AdminPanel.EditingPlayerInfo.name}?<br/><br/>` +
          AdminPanel.Language.amountTranslation,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      bootbox.prompt({
        title:
          AdminPanel.Language.setPedModelForTranslation +
          `${AdminPanel.EditingPlayerInfo.name}`,
        message:
          `<strong>` +
          AdminPanel.Language.modelName +
          `</strong> (eg. a_c_chop, a_c_deer, mp_m_freemode_01)`,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.giveBankMoneyTranslation +
          `</strong> to ${AdminPanel.EditingPlayerInfo.name}?<br/><br/>` +
          AdminPanel.Language.amountTranslation,
        centerVertical: true,
        buttons: {
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.removeBankMoneyTranslation +
          `</strong> from ${AdminPanel.EditingPlayerInfo.name}?<br/><br/>` +
          AdminPanel.Language.amountTranslation,
        centerVertical: true,
        buttons: {
      ...
      $("#confirm-body").html(
        `
                <strong>` +
          AdminPanel.Language.setGangTranslation +
          `</strong> of ${AdminPanel.EditingPlayerInfo.name}?<br/>
      ...
      $("#confirm-body").html(
        `
                <strong>` +
          AdminPanel.Language.giveItemTranslation +
          `</strong> to ${AdminPanel.EditingPlayerInfo.name}?<br/>
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.iplNameTranslation +
          `</strong> (eg. xm_siloentranceclosed_x17)`,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.settimeTranslate +
          `</strong><br/>
                            <span><strong>` +
          AdminPanel.Language.hourTranslation +
          `</strong></span>`,
      ...
      bootbox.confirm({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.removeTranslation +
          `</strong> ${AdminPanel.EditingPlayerInfo.name} ` +
          AdminPanel.Language.FireFromTheirGangTranslation,
        centerVertical: true,
        buttons: {
          confirm: {
            label: AdminPanel.Language.FirePlayerTranslation,
      ...
      $("#confirm-body").html(
        `
                <strong>` +
          AdminPanel.Language.setcolorTranslate +
          `</strong><br/>
                <br/>
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.setliveryTranslate +
          `</strong><br/>
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.spawnvehicleTranslate +
          `</strong><br/>
                          <span><strong>` +
          AdminPanel.Language.modelName +
          `</strong></span>`,
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.messageallTranslate +
          `</strong><br/>
                          <span><strong>` +
          AdminPanel.Language.messageTranslation +
          `</strong></span>`,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      bootbox.confirm({
        title: AdminPanel.Language.AreYouSureTranslation,
        message:
          `<strong>` + AdminPanel.Language.reviveallTranslate + `</strong>`,
        centerVertical: true,
        buttons: {
          confirm: {
      ...
      bootbox.prompt({
        ...
        message:
          `<strong>` +
          AdminPanel.Language.setweatherTranslate +
          `</strong><br/>
                            <span><strong>` +
          AdminPanel.Language.WeatherTypeTranslation +
          `</strong></span>`,
        inputType: "select",
        inputOptions: [
          {
  ...
  $(document).on("click", "#reportsubmit", function (e) {
    ...
    if ($("#inputSubject").val().length <= 5) {
      ...
      $.post(
        `https://${GetParentResourceName()}/SendReport`,
        JSON.stringify({
  ...
  $(document).on("keyup", function (e) {
    if (e.key === "Escape" && AdminPanel.IsOpen && !AdminPanel.ModalOpen) {
      // escape key maps to keycode `27`
      AdminPanel.Close();
    } else if (
      e.key === "Escape" &&
      AdminPanel.ReportScreenOpen &&
      !AdminPanel.ModalOpen
    ) {
      // escape key maps to keycode `27`
      AdminPanel.CloseReportScreen();
    }
...
AdminPanel.ShowAlert = function (type, alertText) {
  ...
  Toast.create("mri-Qadmin", alertText, type, 3000);
};
  ...
  if (AdminPanel.EditingPlayerInfo !== undefined) {
    ...
    var gender = AdminPanel.EditingPlayerInfo.gender
      ? '<span style="color:deeppink"><i class="fas fa-venus"></i> ' +
        AdminPanel.Language.femaleTranslation +
        "</span>"
      : '<span style="color:aqua"><i class="fas fa-mars"></i> ' +
        AdminPanel.Language.maleTranslation +
        "</span>";
    ...
    var injail = AdminPanel.EditingPlayerInfo.injail
    ...
    $("#heading").html(
      AdminPanel.EditingPlayerInfo.name +
        " (" +
        AdminPanel.EditingPlayerInfo.charname +
        ") " +
...
function fallbackCopyTextToClipboard(text) {
  ...
  try {
    ...
    var msg = successful
      ? AdminPanel.Language.successfulTranslation
      : AdminPanel.Language.unsuccessfulTranslation;
    ...
    $("#joblist").append(
      `
            <a href="#jobinfo${key}" class="list-group-item" data-toggle="collapse">
                <i class="fas fa-chevron-right"></i> Job: <strong>${key}</strong> - ` +
    ...
    $("#ganglist").append(
      `
            <a href="#ganginfo${key}" class="list-group-item" data-toggle="collapse">
                <i class="fas fa-chevron-right"></i> Gang: <strong>${key}</strong> - ` +
...
AdminPanel.ResetBansList = function () {
  ...
  AdminPanel.BansList.forEach(function (item, index) {
    $("#banslisttbody").append(`
            ...
            <td>
            <a href="#" id="banlistunban" data-name="${
              item.Name
            }" data-license="${item.License}" data-toggle="tooltip" title="Unban Player" class="h4"><i class="fas fa-gavel"></i></a> 
            <td>
            </tr>
        `);
  });
  ...
  AdminPanel.ReportsList.forEach(function (item, index) {
    if (item) {
      $("#reportslisttbody").append(`
                ...
                <td>
                    <a href="#" id="reportlistviewplayer" data-player="${
                      item.SenderCitizenID
                    }" data-toggle="tooltip" title="View Player Info" class="h4"><i class="fas fa-external-link-square-alt"></i></a> 
                    ...
                    <a href="#" id="reportlistclaimreport" data-id="${
                      item.ReportID
                    }" data-toggle="tooltip" title="Claim Report" class="h4"><i class="fas fa-check-circle"></i></a> 
                    <a href="#" id="reportlistdeletereport" data-id="${
                      item.ReportID
                    }" data-toggle="tooltip" title="Delete Report" class="h4"><i class="fas fa-times-circle"></i></a> 
                <td>
                </tr>
            `);
    }
  ...
  AdminPanel.AdminChat.forEach(function (item, index) {
    $("#adminchatboxul").append(`
            <li>
                <strong>${
                  item.Sender
                }</strong> (${AdminPanel.TimeSince(item.TimeStamp)}): ${item.Message}
            </li>
        `);
  });
  $("#loading").hide();
  ...
  AdminPanel.CharactersList.forEach(function (item, index) {
    if (item.id !== undefined) {
      $("#characterslisttbody").append(`
                <tr data-citizenid="${item.id}">
                <td>${item.id}</td>
                <td>${item.name} ${item.name2}</td>
                <th scope="row">${item.id}</th>
                <td>
                <a href="#" id="characterslistdelete" data-player="${item.id}" data-name="${item.id}'s character '${item.name} ${item.name2}'" data-toggle="tooltip" title="Delete Character" class="h4"><i class="fas fa-user-times"></i></a> 
                <a href="#" id="characterslistgotoplayer" data-player="${item.id}" data-license="${item.id}" data-toggle="tooltip" title="View Player" class="h4"><i class="fas fa-external-link-square-alt"></i></a> 
                <td>
                </tr>
            `);
    } /* else {
...
AdminPanel.ResetLogViewer = function () {
  ...
  Array.from(AdminPanel.ServerLogs).forEach(function (item, index) {
    $("#logslisttbody").append(
      "<tr><td>" +
        AdminPanel.GetReadableTime(item.time) +
        "</td><td>" +
        item.from +
        "</td><td>" +
        item.message +
...
AdminPanel.ResetResourceList = function () {
  $("#resourcelist").empty();
  var string =
    `<table class="table table-sm" id="resourceinfo">
    <thead>
      <tr>
        <th scope="col">` +
  ...
  AdminPanel.ResourcePageInfo.forEach(function (item, index) {
    ...
    string =
      string +
      `<tr style="border-bottom:1px solid grey;"><td><strong>${item[0]}</strong></td><td>${isStarted}</td>
