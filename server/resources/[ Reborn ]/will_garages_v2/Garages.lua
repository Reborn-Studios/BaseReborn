...
elseif GlobalState['Basics']['Theme'] == "SP" then
    Config.garages[384] = { ["name"] = "GCM", ["payment"] = "", ["perm"] = "gcm.permissao",
        ...
        ["spawns"] = {
            { -457.26,302.31,83.02,175.69 },
            { -453.48,302.17,83.02,177.18 },
            { -450.52,301.93,83.02,175.46 }
        }
    }
    Config.garages[496] = { ["name"] = "PMESP", ["payment"] = "", ["perm"] = "pmesp.permissao",
        ["entrada"] = {
            ["blip"] = { -1686.41,-769.48,11.37,229.5 }
        },
        ["spawns"] = {
            { -1682.68,-769.59,10.98,140.00 },
            { -1680.03,-771.52,10.98,140.00 },
            { -1677.46,-773.66,10.98,140.00 },
            { -1674.86,-775.55,10.98,140.00 },
        }
    }
    ...
    Config.garages[498] = { ["name"] = "PMESPHeli", ["payment"] = "", ["perm"] = "pmesp.permissao",
        ["entrada"] = {
            ["blip"] = { -1648.82,-800.21,11.37,136.85 }
        },
        ["spawns"] = {
            { -1649.26,-807.19,11.37,47.79 },
        }
    }
    Config.garages[499] = { ["name"] = "PRF", ["payment"] = false, ["perm"] = "prf.permissao",
        ["entrada"] = {
            ["blip"] = { -3023.04,348.06,15.08,152.87 }
        },
        ["spawns"] = {
            { -3026.7,344.06,14.69,78.81 },
            { -3027.05,340.55,14.69,79.92 },
            { -3027.05,336.55,14.69,79.92 },
        }
    }
    Config.garages[500] = { ["name"] = "PMFT", ["payment"] = false, ["perm"] = "ft.permissao",
        ["entrada"] = {
            ["blip"] = { -753.63,-66.69,37.97,194.97 }
        },
        ["spawns"] = {
            { -753.42,-72.32,37.63,116.63 },
            { -752.03,-74.97,37.63,118.03 },
        }
    }
    Config.garages[501] = { ["name"] = "PCHeli", ["payment"] = false, ["perm"] = "policiacivil.permissao",
        ["entrada"] = {
            ["blip"] = { 2319.52,3892.24,36.65,96.05 }
        },
        ["spawns"] = {
            { 2328.44,3892.39,36.65,211.91 },
        }
    }
    Config.garages[502] = { ["name"] = "PCESP", ["payment"] = false, ["perm"] = "policiacivil.permissao",
        ["entrada"] = {
            ["blip"] = { 2330.05,3925.66,38.7,9.12 }
        },
        ["spawns"] = {
            { 2332.05,3927.82,38.11,35.9 },
            { 2334.75,3929.59,38.11,35.48 },
            { 2337.57,3931.42,38.11,35.13 },
        }
    }
    Config.garages[503] = { ["name"] = "BAEP", ["payment"] = false, ["perm"] = "baep.permissao",
        ["entrada"] = {
            ["blip"] = { -913.95,-1163.34,5.02 }
        },
        ["spawns"] = {
            { -912.54,-1165.67,4.62,120.77 },
            { -910.6,-1168.33,4.61,117.67 },
        }
    }
    Config.garages[504] = { ["name"] = "ROTA", ["payment"] = false, ["perm"] = "rota.permissao",
        ["entrada"] = {
            ["blip"] = { -1131.15,-2301.44,14.43,140.41 }
        },
        ["spawns"] = {
            { -1130.93,-2306.71,14.04,150.92 },
            { -1128.14,-2308.46,14.04,149.31 },
        }
    }
elseif GlobalState['Basics']['Theme'] == "RJ" then
    ...
    Config.garages[502] = { ["name"] = "BOPE", ["payment"] = false, ["perm"] = "bope.permissao",
        ["entrada"] = {
            ["blip"] = { -248.48,1554.46,338.62,225.13 }
        },
        ["spawns"] = {
            { -245.09,1560.62,338.62,267.67 },
            { -244.35,1565.85,338.62,271.84 },
        }
    }
    Config.garages[503] = { ["name"] = "PMERJ", ["payment"] = "", ["perm"] = "pmerj.permissao",
        ["entrada"] = {
    ...
    Config.garages[504] = { ["name"] = "CHOQUE", ["payment"] = "", ["perm"] = "choque.permissao",
        ["entrada"] = {
            ["blip"] = { -797.03,-2693.05,14.13,23.11 }
        },
        ["spawns"] = {
            { -798.18,-2688.41,13.62,60.13 },
        }
    }
end
