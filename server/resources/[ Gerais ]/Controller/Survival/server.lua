			...
			if SvTunnel.Death(nplayer) then
				...
				if not SvTunnel.finalizado(nplayer) then
					...
					SetTimeout(10000,function()
						TriggerClientEvent("cancelando",source,false)
						vRPclient._removeObjects(source)
						TriggerClientEvent("Notify",source,"Reanimação","Cidadão está sem pulso.","ambulance",5000)
						TriggerClientEvent("Notify",nplayer,"Reanimação","Você está sem pulso.","ambulance",5000)
						Wait(120000)
