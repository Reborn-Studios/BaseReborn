...
local animacoes = {
	...
	["dancar381"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_male^1", andar = false, loop = true },
	...
	["dancar423"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_female^6", andar = false, loop = true },
	["dancar424"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_female^5", andar = false, loop = true },
	["dancar425"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_female^4", andar = false, loop = true },
	["dancar426"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_female^2", andar = false, loop = true },
	["dancar427"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_female^1", andar = false, loop = true },
	["dancar428"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_male^6", andar = false, loop = true },
	["dancar429"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_male^5", andar = false, loop = true },
	["dancar430"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_male^4", andar = false, loop = true },
	["dancar431"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_male^3", andar = false, loop = true },
	["dancar432"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_male^2", andar = false, loop = true },
	["dancar433"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_male^1", andar = false, loop = true },
	["dancar434"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_male^3", andar = false, loop = true },
	["dancar435"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_male^2", andar = false, loop = true },
	["dancar436"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_male^1", andar = false, loop = true },
	["dancar437"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_male^6", andar = false, loop = true },
	["dancar438"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_male^5", andar = false, loop = true },
	["dancar439"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_male^4", andar = false, loop = true },
	["dancar440"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_female^6", andar = false, loop = true },
	["dancar441"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_female^5", andar = false, loop = true },
	["dancar442"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_female^4", andar = false, loop = true },
	["dancar443"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_female^3", andar = false, loop = true },
	["dancar444"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_male^2", andar = false, loop = true },
	["dancar445"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_male^1", andar = false, loop = true },
	["dancar446"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_male^6", andar = false, loop = true },
	["dancar447"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_male^5", andar = false, loop = true },
	["dancar448"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_male^4", andar = false, loop = true },
	["dancar449"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_female^6", andar = false, loop = true },
	["dancar450"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_female^5", andar = false, loop = true },
	["dancar451"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_female^4", andar = false, loop = true },
	["dancar452"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_female^3", andar = false, loop = true },
	["dancar453"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_female^2", andar = false, loop = true },
	["dancar454"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_male^3", andar = false, loop = true },
	["dancar455"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_female^5", andar = false, loop = true },
	["dancar456"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_female^4", andar = false, loop = true },
	["dancar457"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_female^3", andar = false, loop = true },
	["dancar458"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_female^2", andar = false, loop = true },
	["dancar459"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_female^5", andar = false, loop = true },
	["dancar460"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_female^4", andar = false, loop = true },
	["dancar461"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_female^3", andar = false, loop = true },
	["dancar462"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_female^2", andar = false, loop = true },
	["dancar463"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_female^1", andar = false, loop = true },
	["dancar464"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_female^6", andar = false, loop = true },
	["dancar465"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_female^1", andar = false, loop = true },
	["dancar466"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_male^6", andar = false, loop = true },
	["dancar367"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_male^5", andar = false, loop = true },
	["dancar468"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_male^4", andar = false, loop = true },
	["dancar469"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_male^3", andar = false, loop = true },
	["dancar470"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_male^2", andar = false, loop = true },
	["dancar471"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_09_v1_male^1", andar = false, loop = true },
	["dancar472"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_female^6", andar = false, loop = true },
	["dancar473"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_female^5", andar = false, loop = true },
	["dancar474"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_female^4", andar = false, loop = true },
	["dancar475"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_female^3", andar = false, loop = true },
	["dancar476"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_female^2", andar = false, loop = true },
	["dancar477"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_female^1", andar = false, loop = true },
	["dancar478"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_female^6", andar = false, loop = true },
	["dancar479"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_male^6", andar = false, loop = true },
	["dancar480"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_male^5", andar = false, loop = true },
	["dancar481"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_male^1", andar = false, loop = true },
	["dancar482"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_male^4", andar = false, loop = true },
	["dancar483"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_male^3", andar = false, loop = true },
	["dancar484"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_male^2", andar = false, loop = true },
	["dancar485"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_male^5", andar = false, loop = true },
	["dancar486"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_female^1", andar = false, loop = true },
	["dancar487"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_male^6", andar = false, loop = true },
	["dancar488"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_female^6", andar = false, loop = true },
	["dancar489"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_female^3", andar = false, loop = true },
	["dancar490"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_female^2", andar = false, loop = true },
	["dancar491"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v2_female^4", andar = false, loop = true },
	["dancar492"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v2_female^3", andar = false, loop = true },
	["dancar493"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v2_female^2", andar = false, loop = true },
	["dancar494"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v2_female^1", andar = false, loop = true },
	["dancar495"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_male^4", andar = false, loop = true },
	["dancar496"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_male^3", andar = false, loop = true },
	["dancar497"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_male^2", andar = false, loop = true },
	["dancar498"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_male^1", andar = false, loop = true },
	["dancar499"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_female^1", andar = false, loop = true },
	["dancar500"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_female^5", andar = false, loop = true },
	["dancar501"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_11_v1_female^4", andar = false, loop = true },
	["dancar502"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_male^6", andar = false, loop = true },
	["dancar503"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_male^5", andar = false, loop = true },
	["dancar504"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_male^4", andar = false, loop = true },
	["dancar505"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_male^3", andar = false, loop = true },
	["dancar506"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_male^2", andar = false, loop = true },
	["dancar507"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v1_male^1", andar = false, loop = true },
	["dancar508"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v2_female^6", andar = false, loop = true },
	["dancar509"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v2_female^5", andar = false, loop = true },
	["dancar510"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_male^5", andar = false, loop = true },
	["dancar511"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_male^3", andar = false, loop = true },
	["dancar512"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_male^2", andar = false, loop = true },
	["dancar513"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_male^1", andar = false, loop = true },
	["dancar514"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_female^3", andar = false, loop = true },
	["dancar515"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_male^4", andar = false, loop = true },
	["dancar516"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_female^6", andar = false, loop = true },
	["dancar517"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_female^5", andar = false, loop = true },
	["dancar518"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_female^4", andar = false, loop = true },
	["dancar519"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_female^2", andar = false, loop = true },
	["dancar520"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_17_v1_female^1", andar = false, loop = true },
	["dancar521"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_15_v1_male^6", andar = false, loop = true },
	["dancar522"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_female^5", andar = false, loop = true },
	["dancar523"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_female^4", andar = false, loop = true },
	["dancar524"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_female^3", andar = false, loop = true },
	["dancar525"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_female^2", andar = false, loop = true },
	["dancar526"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_male^3", andar = false, loop = true },
	["dancar527"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_male^2", andar = false, loop = true },
	["dancar528"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_male^1", andar = false, loop = true },
	["dancar529"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_female^6", andar = false, loop = true },
	["dancar530"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_09_v1_female^1", andar = false, loop = true },
	["dancar531"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_female^6", andar = false, loop = true },
	["dancar532"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_male^6", andar = false, loop = true },
	["dancar533"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_male^5", andar = false, loop = true },
	["dancar534"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_17_v1_male^4", andar = false, loop = true },
	["dancar535"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_female^4", andar = false, loop = true },
	["dancar536"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_female^3", andar = false, loop = true },
	["dancar537"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_female^2", andar = false, loop = true },
	["dancar538"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_female^1", andar = false, loop = true },
	["dancar539"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_female^6", andar = false, loop = true },
	["dancar540"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_female^5", andar = false, loop = true },
	["dancar541"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_male^6", andar = false, loop = true },
	["dancar542"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_male^5", andar = false, loop = true },
	["dancar543"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_male^4", andar = false, loop = true },
	["dancar544"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_male^2", andar = false, loop = true },
	["dancar545"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_male^1", andar = false, loop = true },
	["dancar546"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v1_male^3", andar = false, loop = true },
	["dancar547"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_female^4", andar = false, loop = true },
	["dancar548"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_female^3", andar = false, loop = true },
	["dancar549"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_female^2", andar = false, loop = true },
	["dancar550"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_female^1", andar = false, loop = true },
	["dancar551"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_female^6", andar = false, loop = true },
	["dancar552"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_13_v2_female^5", andar = false, loop = true },
	["dancar553"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_male^6", andar = false, loop = true },
	["dancar554"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_male^5", andar = false, loop = true },
	["dancar555"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_male^4", andar = false, loop = true },
	["dancar556"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_male^3", andar = false, loop = true },
	["dancar557"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_male^2", andar = false, loop = true },
	["dancar558"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_15_v1_male^1", andar = false, loop = true },
	["dancar559"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v1_male^6", andar = false, loop = true },
	["dancar560"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v1_male^5", andar = false, loop = true },
	["dancar561"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v1_male^4", andar = false, loop = true },
	["dancar562"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v1_male^3", andar = false, loop = true },
	["dancar563"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v1_male^2", andar = false, loop = true },
	["dancar564"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_13_v1_male^1", andar = false, loop = true },
	["dancar565"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_female^3", andar = false, loop = true },
	["dancar566"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_female^2", andar = false, loop = true },
	["dancar567"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_female^1", andar = false, loop = true },
	["dancar568"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_female^5", andar = false, loop = true },
	["dancar569"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_female^4", andar = false, loop = true },
	["dancar570"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_male^6", andar = false, loop = true },
	["dancar571"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_male^5", andar = false, loop = true },
	["dancar572"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_male^4", andar = false, loop = true },
	["dancar573"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_male^3", andar = false, loop = true },
	["dancar574"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_male^2", andar = false, loop = true },
	["dancar575"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_male^1", andar = false, loop = true },
	["dancar576"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_male^2", andar = false, loop = true },
	["dancar577"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_male^1", andar = false, loop = true },
	["dancar578"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_male^6", andar = false, loop = true },
	["dancar579"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_male^6", andar = false, loop = true },
	["dancar580"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_male^5", andar = false, loop = true },
	["dancar581"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_male^4", andar = false, loop = true },
	["dancar582"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_male^3", andar = false, loop = true },
	["dancar583"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_11_v1_male^3", andar = false, loop = true },
	["dancar584"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_11_v1_male^2", andar = false, loop = true },
	["dancar585"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_11_v1_male^1", andar = false, loop = true },
	["dancar586"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_male^5", andar = false, loop = true },
	["dancar587"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_male^4", andar = false, loop = true },
	["dancar588"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_male^3", andar = false, loop = true },
	["dancar589"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_male^2", andar = false, loop = true },
	["dancar590"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_male^1", andar = false, loop = true },
	["dancar591"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_female^6", andar = false, loop = true },
	["dancar592"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_male^6", andar = false, loop = true },
	["dancar593"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_male^5", andar = false, loop = true },
	["dancar594"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_male^4", andar = false, loop = true },
	["dancar595"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "mi_dance_prop_17_v1_male^3", andar = false, loop = true },
	["dancar596"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_15_v1_female^6", andar = false, loop = true },
	["dancar597"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_female^5", andar = false, loop = true },
	["dancar598"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_female^4", andar = false, loop = true },
	["dancar599"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_female^3", andar = false, loop = true },
	["dancar601"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_female^2", andar = false, loop = true },
	["dancar602"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_09_v1_female^1", andar = false, loop = true },
	["dancar603"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_female^6", andar = false, loop = true },
	["dancar604"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_female^5", andar = false, loop = true },
	["dancar605"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_female^4", andar = false, loop = true },
	["dancar606"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_female^3", andar = false, loop = true },
	["dancar607"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_female^2", andar = false, loop = true },
	["dancar608"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "hi_dance_prop_11_v1_female^1", andar = false, loop = true },
	["dancar609"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_female^4", andar = false, loop = true },
	["dancar610"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_female^3", andar = false, loop = true },
	["dancar611"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_female^5", andar = false, loop = true },
	["dancar612"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_female^2", andar = false, loop = true },
	["dancar613"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props@", anim = "li_dance_prop_13_v2_female^1", andar = false, loop = true },
	["dancar614"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_female^6", andar = false, loop = true },
	["dancar615"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_female^2", andar = false, loop = true },
	["dancar616"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_male^5", andar = false, loop = true },
	["dancar617"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_male^3", andar = false, loop = true },
	["dancar618"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_male^1", andar = false, loop = true },
	["dancar619"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_female^1", andar = false, loop = true },
	["dancar620"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_male^3", andar = false, loop = true },
	["dancar621"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_female^6", andar = false, loop = true },
	["dancar622"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_male^4", andar = false, loop = true },
	["dancar623"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_female^5", andar = false, loop = true },
	["dancar624"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_female^3", andar = false, loop = true },
	["dancar625"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_female^4", andar = false, loop = true },
	["dancar626"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_female^6", andar = false, loop = true },
	["dancar627"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_female^2", andar = false, loop = true },
	["dancar628"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_female^3", andar = false, loop = true },
	["dancar629"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_female^2", andar = false, loop = true },
	["dancar630"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_male^4", andar = false, loop = true },
	["dancar631"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_male^1", andar = false, loop = true },
	["dancar632"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_male^5", andar = false, loop = true },
	["dancar633"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_female^3", andar = false, loop = true },
	["dancar634"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_female^1", andar = false, loop = true },
	["dancar635"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_female^4", andar = false, loop = true },
	["dancar636"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_male^5", andar = false, loop = true },
	["dancar637"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_male^3", andar = false, loop = true },
	["dancar638"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_male^5", andar = false, loop = true },
	["dancar639"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_male^1", andar = false, loop = true },
	["dancar640"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_female^6", andar = false, loop = true },
	["dancar641"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_male^2", andar = false, loop = true },
	["dancar642"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_female^4", andar = false, loop = true },
	["dancar643"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_male^5", andar = false, loop = true },
	["dancar644"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_female^5", andar = false, loop = true },
	["dancar645"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_female^3", andar = false, loop = true },
	["dancar646"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_male^6", andar = false, loop = true },
	["dancar647"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_female^6", andar = false, loop = true },
	["dancar648"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_male^2", andar = false, loop = true },
	["dancar649"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_female^5", andar = false, loop = true },
	["dancar650"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_male^4", andar = false, loop = true },
	["dancar651"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_female^1", andar = false, loop = true },
	["dancar652"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_female^2", andar = false, loop = true },
	["dancar653"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_female^2", andar = false, loop = true },
	["dancar654"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_male^2", andar = false, loop = true },
	["dancar655"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_female^3", andar = false, loop = true },
	["dancar656"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_female^2", andar = false, loop = true },
	["dancar657"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_female^5", andar = false, loop = true },
	["dancar658"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_female^1", andar = false, loop = true },
	["dancar659"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_male^2", andar = false, loop = true },
	["dancar660"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_female^6", andar = false, loop = true },
	["dancar661"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_male^4", andar = false, loop = true },
	["dancar662"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_female^4", andar = false, loop = true },
	["dancar663"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_male^6", andar = false, loop = true },
	["dancar664"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_male^3", andar = false, loop = true },
	["dancar665"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_male^1", andar = false, loop = true },
	["dancar666"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_female^5", andar = false, loop = true },
	["dancar667"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_male^3", andar = false, loop = true },
	["dancar668"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_male^4", andar = false, loop = true },
	["dancar669"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_male^3", andar = false, loop = true },
	["dancar670"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_female^1", andar = false, loop = true },
	["dancar671"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_male^6", andar = false, loop = true },
	["dancar672"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_female^4", andar = false, loop = true },
	["dancar673"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_male^5", andar = false, loop = true },
	["dancar674"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_female^1", andar = false, loop = true },
	["dancar675"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_male^1", andar = false, loop = true },
	["dancar676"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_male^6", andar = false, loop = true },
	["dancar677"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_female^4", andar = false, loop = true },
	["dancar678"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_male^3", andar = false, loop = true },
	["dancar679"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_male^1", andar = false, loop = true },
	["dancar680"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_male^2", andar = false, loop = true },
	["dancar681"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_male^6", andar = false, loop = true },
	["dancar682"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_male^4", andar = false, loop = true },
	["dancar683"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_09_v1_female^5", andar = false, loop = true },
	["dancar684"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_female^3", andar = false, loop = true },
	["dancar685"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_female^3", andar = false, loop = true },
	["dancar686"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_male^5", andar = false, loop = true },
	["dancar687"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_male^4", andar = false, loop = true },
	["dancar688"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_li_09_v1_male^2", andar = false, loop = true },
	["dancar689"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_mi_11_v1_female^2", andar = false, loop = true },
	["dancar690"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_female^5", andar = false, loop = true },
	["dancar691"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_li_11_v1_male^6", andar = false, loop = true },
	["dancar692"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_male^6", andar = false, loop = true },
	["dancar693"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_li_to_hi_07_v1_male^2", andar = false, loop = true },
	["dancar694"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_female^6", andar = false, loop = true },
	["dancar695"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_mi_to_hi_11_v1_female^1", andar = false, loop = true },
	["dancar696"] = { dict = "anim@amb@nightclub_island@dancers@crowddance_single_props_transitions@", anim = "trans_dance_prop_hi_to_mi_11_v1_female^4", andar = false, loop = true },
	...
	["sentar2"] = { dict = "sol_3_int-9", anim = "cs_molly_dual-9", andar = false, loop = true },
	...
	["sentar41"] = { dict = "drf_mic_1_cs_1-15", anim = "cs_drfriedlander_dual-15", andar = false, loop = true },
	...
	["sentar55"] = { dict = "missheist_jewelleadinout", anim = "jh_int_outro_loop_d", andar = false, loop = true },
	...
	["sentar64"] = { dict = "sil_int-29", anim = "mp_m_freemode_01^3_dual-29", andar = false, loop = true },
	["sentar65"] = { dict = "anim@amb@clubhouse@boardroom@crew@female@var_a@base_r@", anim = "base", andar = false, loop = true },
	...
	["sentar72"] = { dict = "anim@amb@office@seating@female@var_b@base@", anim = "base", andar = false, loop = true },
	["sentar73"] = { dict = "rcmnigel1a_band_groupies", anim = "bump_f1", andar = false, loop = true },
	["sentar74"] = { dict = "anim@amb@facility@briefing_room@seating@male@var_a@", anim = "base", andar = false, loop = true },
	...
	["sentar76"] = { dict = "arm_1_mcs_2_concat-0", anim = "cs_denise_dual-0", andar = false, loop = true },
	["sentar77"] = { dict = "timetable@reunited@ig_7", anim = "amandabase_amanda", andar = false, loop = true },
	["sentar78"] = { dict = "anim@amb@yacht@jacuzzi@seated@female@variation_05@", anim = "idle_a", andar = false, loop = true },
	["sentar79"] = { dict = "family_4_mcs_2-2", anim = "csb_hugh_dual-2", andar = false, loop = true },
	["sentar80"] = { dict = "anim@amb@office@boardroom@crew@female@var_a@base_r@", anim = "base", andar = false, loop = true },
	...
	["sentar85"] = { dict = "amb@incar@male@smoking_van@enter", anim = "enter", andar = false, loop = true },
	...
	["foto48"] = { dict = "armenian_1_int-3", anim = "a_f_y_fitness_02^5-3", andar = false, loop = true },
	...
	["foto77"] = { dict = "armenian_1_int-33", anim = "ig_lamardavis_dual-33", andar = false, loop = true },
	...
	["tiktok18"] = { dict = "custom@crossbounce", anim = "crossbounce", andar = false, loop = true },
	["tiktok19"] = { dict = "custom@dont_start", anim = "dont_start", andar = false, loop = true },
	["tiktok20"] = { dict = "custom@floss", anim = "floss", andar = false, loop = true },
	["tiktok21"] = { dict = "custom@orangejustice", anim = "orangejustice", andar = false, loop = true },
	["tiktok22"] = { dict = "custom@renegade", anim = "renegade", andar = false, loop = true },
	["tiktok23"] = { dict = "custom@rickroll", anim = "rickroll", andar = false, loop = true },
	["tiktok24"] = { dict = "custom@savage", anim = "savage", andar = false, loop = true },
	["tiktok25"] = { dict = "custom@sayso", anim = "sayso", andar = false, loop = true },
	["tiktok26"] = { dict = "custom@take_l", anim = "take_l", andar = false, loop = true },
	...
	["tiktok54"] = { dict = "custom@armswirl", anim = "armswirl", andar = false, loop = true },
	...
	["cayo12"] = { dict = "anim@amb@nightclub_island@dancers@club@", anim = "hi_to_ti_f03", andar = false, loop = true },
	...
	["cayo21"] = { dict = "anim@amb@nightclub_island@dancers@club@", anim = "hi_idle_a_f01", andar = false, loop = true },
	...
	["cayo26"] = { dict = "anim@amb@nightclub_island@dancers@club@", anim = "hi_to_ti_f02", andar = false, loop = true },
	...
	["encostar18"] = { dict = "rcmnigel1a_band_groupies", anim = "base_m2", andar = false, loop = true },
	...
	["encostar25"] = { dict = "missheistdockssetup1ig_12@base", anim = "talk_gantry_idle_base_worker4", andar = false, loop = true },
	["encostar26"] = { dict = "missstrip_club_lean", anim = "player_lean_rail_loop", andar = false, loop = true },
	...
	["encostar55"] = { dict = "anim@amb@business@meth@meth_monitoring_no_work@", anim = "turnaround_idle_v1_lazycook", andar = false, loop = true },
	["encostar56"] = { dict = "sub_int-42", anim = "a_m_y_busicas_01_dual-42", andar = false, loop = true },
	["encostar57"] = { dict = "fra_0_int-9", anim = "player_one_dual-9", andar = false, loop = true },
	["encostar58"] = { dict = "anim@amb@nightclub@dancers@club_ambientpeds@low-med_intensity", anim = "li-mi_amb_club_10_v1_male^3", andar = false, loop = true },
	...
	["cruzar8"] = { dict = "anim@amb@nightclub@peds@", anim = "rcmme_amanda1_stand_loop_cop", andar = true, loop = true },
	...
	["superstar"] = { anim = "prem_4stars_a_molly", dict  = "missmic4premiere", andar = false, loop = true },
	["superstar1"] = { anim = "prem_4stars_a_ruben", dict  = "missmic4premiere", andar = false, loop = true },
	["superstar2"] = { anim = "idle_a", dict  = "random@bus_tour_guide@idle_a", andar = false, loop = true },
	["superstar3"] = { anim = "prem_4stars_a_benton", dict  = "missmic4premiere", andar = false, loop = true },
	["superstar4"] = { anim = "prem_milton_milton_a", dict  = "missmic4premiere", andar = false, loop = true },
	...
	["acenar4"] = { dict = "anim@mp_player_intcelebrationfemale@wave", anim = "wave", andar = true, loop = false },
	["acenar5"] = { dict = "friends@frj@ig_1", anim = "wave_c", andar = true, loop = false },
	["acenar6"] = { dict = "friends@frj@ig_1", anim = "wave_d", andar = true, loop = false },
	...
	["porta2"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_02", andar = true, loop = true, flag = 49, mao = 28422, pos1 = 0.0, pos2 = -0.1, pos3 = -0.15, pos4 = 0.0, pos5 = 0.0, pos6 = 0.0, propAnim = true },
	["porta3"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_03", andar = true, loop = true, flag = 49, mao = 28422, pos1 = 0.0, pos2 = -0.1, pos3 = -0.15, pos4 = 0.0, pos5 = 0.0, pos6 = 0.0, propAnim = true },
	["porta4"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_door_04", andar = true, loop = true, flag = 49, mao = 28422, pos1 = 0.0, pos2 = -0.1, pos3 = -0.15, pos4 = 0.0, pos5 = 0.0, pos6 = 0.0, propAnim = true },
	["banco"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_car_seat", andar = true, loop = true, flag = 49, mao = 28422, pos1 = 0.0, pos2 = -0.2, pos3 = -0.14, pos4 = 0.0, pos5 = 0.0, pos6 = 0.0, propAnim = true },
	["pneu"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_wheel_tyre", andar = true, loop = true, flag = 49, mao = 28422, pos1 = 0.0, pos2 = -0.1, pos3 = -0.15, pos4 = 0.0, pos5 = 0.0, pos6 = 0.0, propAnim = true },
	["pneu2"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_wheel_03", andar = true, loop = true, flag = 49, mao = 28422, pos1 = 0.0, pos2 = -0.1, pos3 = -0.15, pos4 = 0.0, pos5 = 0.0, pos6 = 0.0, propAnim = true },
	...
	["checkin"] = { dict = "anim@gangops@morgue@table@" , anim = "body_search" , andar = false , loop = true , extra = function()
		local ped = PlayerPedId()
		local x,y,z = table.unpack(GetEntityCoords(ped))
		for k,v in pairs(beds) do
			local object = GetClosestObjectOfType(x,y,z,0.9,v[1],0,0,0)
...
AddEventHandler("emotes",function(nome)
	local ped = PlayerPedId()
	if animacoes[nome] and not IsPedArmed(ped,6) then
		if (GetEntityHealth(ped) > 101 or nome == "checkin") then
			vRP.removeObjects("one")
			if not IsPedInAnyVehicle(ped) and not animacoes[nome].cars then
				if animacoes[nome].extra then animacoes[nome].extra() end
				...
				elseif animacoes[nome].dict then
					vRP._playAnim(animacoes[nome].andar,{animacoes[nome].dict,animacoes[nome].anim},animacoes[nome].loop)
				else
					vRP._playAnim(false,{task=animacoes[nome].anim},false)
				end
			else
...
CreateThread(function()
	while true do
		...
		if tablet then
			...
			local cam = CreateCam("DEFAULT_SCRIPTED_FLY_CAMERA",true)
			AttachCamToEntity(cam,PlayerPedId(),0.0,0.0,80.0,true)
			SetCamRot(cam,-80.0,0.0,GetEntityHeading(PlayerPedId()))
			SetCamFov(cam,fov)
			RenderScriptCams(true,false,0,1,0)
			while tablet do
				Wait(4)
...
-- USEBINOCULOS
-----------------------------------------------------------------------------------------------------------------------------------------
RegisterNetEvent("useTablet")
AddEventHandler("useTablet",function()
	tablet = true
end)

RegisterNetEvent("cancelTablet")
AddEventHandler("cancelTablet",function()
	tablet = false
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- BINOCULOS
