...
-- SYNCTARGET
-----------------------------------------------------------------------------------------------------------------------------------------
function rpVRP.syncTarget(target,animationLib,animation2,distans,distans2,height,length,spin,controlFlag)
	vRP.removeObjects()
	local ped = PlayerPedId()
...
-- SYNCSOURCE
-----------------------------------------------------------------------------------------------------------------------------------------
function rpVRP.syncSource(animationLib,animation,length,controlFlag,animFlag)
	local ped = PlayerPedId()
