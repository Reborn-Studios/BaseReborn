return {
	General = {
		...
		inventory = {
			...
			{ name = 'cola', price = 20 },
			{ name = 'fries', price = 20 },
			{ name = 'energetic', price = 50 },
			{ name = 'chocolate', price = 30 },
			{ name = 'tacos', price = 30 },
			{ name = 'soda', price = 25 },
			{ name = 'backpackp', price = 200 },
			{ name = 'backpackm', price = 500 },
			{ name = 'backpackg', price = 1000 },
			{ name = 'backpackx', price = 2000 },
		}, locations = {
	...
	VendingMachineDrinks = {
		...
		model = {
			`prop_vend_soda_02`, `prop_vend_fridge01`, `prop_vend_water_01`, `prop_vend_soda_01`, 992069095, 1114264700
		}
	},
