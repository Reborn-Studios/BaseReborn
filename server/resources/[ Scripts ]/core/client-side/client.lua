...
CreateThread(function ()
	...
	elseif GlobalState['Basics']['Theme'] == "SP" then
		OtherBlips = {
			{ 2338.36,3902.19,38.2,60,1,"PCESP",0.6 },
			{ -1142.4,-2265.36,14.98,60,28,"ROTA",0.6 },
			{ -1681.6,-769.63,11.32,60,4,"PMESP",0.6 },
			{ -494.8,276.72,84.59,60,3,"GCM",0.6 },
			{ -3013.14,366.64,15.38,60,46,"BPRV",0.6 },
			{ -936.13,-1188.39,5.88,60,6,"BAEP",0.6 },
			{ -715.35,-55.54,38.54,60,40,"FT",0.6 },
			{ -878.98,-2179.12,9.96,80,35,"UPA",0.6 },
		}
	elseif GlobalState['Basics']['Theme'] == "RJ" then
		OtherBlips = {
			{ -1610.15,180.14,59.66,60,4,"PMERJ",0.6 },
			{ -909.71,-2045.05,9.3,60,4,"PCERJ",0.6 },
			{ -2015.1,-473.01,14.51,60,4,"CORE",0.6 },
			{ -806.41,-2653.6,15.37,60,4,"CHOQUE",0.6 },
			{ -233.22,1542.78,337.79,60,4,"BOPE",0.6 },
		}
	end
