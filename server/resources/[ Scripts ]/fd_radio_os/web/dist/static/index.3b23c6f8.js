...
function oc(e, t) {
  ...
  return (
    o.set(e, t),
    c ? yr(t, f) && en(o, "set", e, t) : en(o, "add", e, t),
    this
  );
}
function rc(e) {
...
function ci(e, t) {
  return function (i, l) {
    ...
    return (
      !e && wt(d, "iterate", Xn),
      f.forEach((b, P) => i.call(l, v(b), v(P), c))
    );
  };
}
function ui(e, t, o) {
  ...
  return (
    d
      ...
      : !l.length && !o && !i
        ? (v = t)
        : ((v = {}),
          l.length && l.forEach((b) => Ei(v, b, f, !0)),
          Ei(v, t, f)),
    Ie(t) && c.set(t, v),
    v
  );
...
function Sm(e, t) {
  ...
  return (
    t && ([oo, Rt] = t(St)),
    { render: Lo, hydrate: oo, createApp: Om(Lo, oo) }
  );
}
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    (Object.defineProperty(Ye, "__esModule", { value: !0 }),
      ...
      (Ye.makeModifier = function (n, r) {
        ...
        return (
          r && typeof r == "string" && ((u._defaults = s), (u._methods = a)),
          u
        );
      }));
    var Od = {
      ...
      set: function (n) {
        ...
        if (g) {
          ...
          ((r.x = Math.max(Math.min(h.right - p.right, r.x), h.left + p.left)),
            (r.y = Math.max(
              Math.min(h.bottom - p.bottom, r.y),
              h.top + p.top,
            )));
        }
      },
    ...
    var Vl = {
      start: function (n) {
        ...
        if (m.offset === "startCoords")
          ...
          (((r = (0, de.rectToXY)(w) || { x: 0, y: 0 }).x += y.x),
            (r.y += y.y));
        }
...
const ky = Sy(Ty, [["render", Ay]]),
  ...
  o0 = {
    key: 0,
    class: "fixed right-2 top-1/2 opacity-50 flex flex-col items-end",
  },
...
function If(e, t) {
  ...
  return (
    t.reference[l] > t.floating[l] && (c = Mi(c)),
    { main: c, cross: Mi(c) }
  );
}
