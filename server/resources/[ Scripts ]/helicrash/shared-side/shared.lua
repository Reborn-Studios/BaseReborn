...
Loots = {
	{
        ...
        ["2"] = { item = "vest", amount = 1 },
        ["3"] = { item = "WEAPON_SMG_AMMO", amount = math.random(500,600) },
        ["4"] = { item = "dollars", amount = math.random(4000,5000) }
    },{
        ["1"] = { item = "at_flashlight", amount = math.random(2,3) },
        ["2"] = { item = "at_suppressor_light", amount = math.random(2,3) },
        ["3"] = { item = "at_grip", amount = math.random(2,3) },
        ["4"] = { item = "dollars", amount = math.random(4000,5000) }
    },{
        ["1"] = { item = "at_grip", amount = math.random(2,3) },
        ["2"] = { item = "at_clip_extended_pistol", amount = math.random(2,3) },
        ["3"] = { item = "at_clip_extended_smg", amount = math.random(2,3) },
        ["4"] = { item = "at_clip_extended_shotgun", amount = math.random(2,3) },
        ["5"] = { item = "at_clip_extended_rifle", amount = math.random(2,3) },
        ["6"] = { item = "dollars", amount = math.random(4000,5000) }
    }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- BURN
