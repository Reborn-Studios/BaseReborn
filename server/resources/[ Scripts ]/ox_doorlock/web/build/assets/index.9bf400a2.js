        ...
        U(et.Dropdown, {
          children: [
            ...
            S(et.Item, {
              ...
              children: "Teleportar para Porta",
            }),
            S(et.Item, {
              color: "red",
              icon: S(Wi, { size: 18 }),
    ...
    return S(it, {
      children: U(gu, {
        ...
        children: [
          ...
          S(Lo, {
            label: "Distance para Abrir a porta",
            type: "number",
            value: n || 0,
            setValue: (c) => s(c),
            infoCircle:
              "Controla a distância a partir da qual o jogador pode interagir com a porta",
          }),
          S(Lo, {
            label: "Door Rate",
            type: "number",
            ...
            value: o || 0,
            setValue: (c) => u(c),
            infoCircle: "Velocidade em que a porta automática se moverá",
          }),
        ],
      }),
    });
    ...
    return S(it, {
      children: U(ab, {
        ...
        children: [
          ...
          S(_n, {
            label: "Porta Dupla",
            infoCircle: "Ative se a porta alvo for uma porta dupla.",
            value: t || !1,
            toggle: () => l("doors"),
          }),
          S(_n, {
            ...
            infoCircle:
              "Ative se a porta de destino estiver se movendo automaticamente. (Garagens, postes, etc...)",
            value: r || !1,
            toggle: () => l("auto"),
          }),
          S(_n, {
            label: "Usar Lockpick",
            infoCircle:
              "Permite que a porta alvo seja arrombada. É possível definir a dificuldade dos testes de habilidade na aba Arrombamento; caso contrário, utiliza os valores padrão da configuração.",
            value: n || !1,
            toggle: () => l("lockpick"),
          }),
          S(_n, {
            label: "Ocultar Tranca",
            infoCircle: "Oculta a tranca para o player não ver",
            value: o || !1,
            toggle: () => l("hideUi"),
          }),
          S(_n, {
            label: "Manter Aberto",
            infoCircle:
              "Define se a(s) porta(s) alvo devem permanecer abertas enquanto estiverem destrancadas.",
            value: i || !1,
            toggle: () => l("holdOpen"),
          }),
        ],
    ...
    return U(J_, {
      children: [
        S(Kn, {
          ...
          onClick: () => n(),
          fullWidth: !0,
          children: "Confirmar Porta",
        }),
        S(nt, {
          label: t
            ? "Apply copied settings"
            : "Nenhuma configuração de porta foi copiada",
          withArrow: !0,
          arrowSize: 10,
          children: S($t, {
            variant: "outline",
    ...
    return S("form", {
      ...
      children: U(Tt, {
        children: [
          S(Oi, {
            data: e,
            placeholder: "Dificuldade do lockpick",
          ...
          S($i, {
            ...
            description: "Tamanho da área de teste de habilidade em graus",
            disabled: n !== "custom",
            max: 360,
            hideControls: !0,
            required: n === "custom",
          ...
          S($i, {
            ...
            description:
              "O número que indica a velocidade será multiplicado por",
            disabled: n !== "custom",
            ...
            jt,
            {
              ...
              children: [
                S(Oi, {
                  ...
                  readOnly: !0,
                  placeholder: "Editar linha para selecionar o valor",
                  sx: { width: "80%" },
                }),
                S(nt, {
                  label: "Editar Linha",
